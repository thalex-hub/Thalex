...
export default function LeaveRequests() {
  ...
  const handleApprove = async (req: any, status: 'approved' | 'rejected' | 'returned', providedReason?: string) => {
    if (!appUser) return;
            ...
            >
              <div className="flex flex-col items-center text-center mb-6">
                ...
                <p className="text-gray-500 text-sm">
                  Bạn có chắc chắn muốn xóa đơn xin nghỉ này? Hành động này không thể hoàn tác.
                </p>
              </div>
            ...
            >
              <div className="flex flex-col items-center text-center mb-6">
                ...
                <p className="text-gray-500 text-sm mb-4">
                  Vui lòng cung cấp lý do bạn từ chối hoặc yêu cầu chỉnh sửa lại đơn nghỉ phép này.
                </p>
                <textarea
              ...
              <div className="flex gap-3">
                ...
                <button 
                  ...
                  onClick={async () => {
                    ...
                    await handleApprove(data.req, data.action, reason);
                  }} 
                  className="flex-1 py-3 bg-red-600 text-white rounded-xl font-bold hover:bg-red-700 shadow-lg shadow-red-100 transition-colors uppercase tracking-wider text-xs"
                >
                  Xác nhận
